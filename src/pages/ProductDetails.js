  ...
  return (
    <div className="details">
      <Top className={show ? "show" : ""}>
        <Wrapper style={{ marginTop: 20 }}>
          ...
          <Notifications style={{ width: "40%", cursor: "pointer" }}>
            ...
            <ShareOutlinedIcon />
            <CartDetailsModal create={true} count={1} />
          </Notifications>
        </Wrapper>
      </Top>
      <ImageContainer>
      ...
      <div className="desc" style={{ paddingLeft: 10 }}>
        <p>
          <BadgeOutlinedIcon style={{ fontSize: 13 }} /> tokobaju.id
        </p>
      </div>
      ...
      <p style={{ color: "darkgrey", textAlign: "center" }}>
        <StarOutlinedIcon style={{ color: "yellow" }} /> 4.9 Ratings{" "}
        <span id="dot">.</span> 2.3k+ Reviews <span id="dot">.</span> 2.9k+ Sold
      </p>
      <Tabs>
      ...
      <Review>
        <div className="desc-review">
          Brand: <span>ChArmkpR</span>
        </div>
        <div className="desc-review">
          Colour: <span>Aprikot</span>
        </div>
      </Review>
      <div className="cart">
        <Items>
        ...
        <Button>
          <Left>
            ...
            <span style={{ marginLeft: 5, fontSize: 18 }}>1</span>
          </Left>
          <Right>Buy Now</Right>
        </Button>
      </div>
